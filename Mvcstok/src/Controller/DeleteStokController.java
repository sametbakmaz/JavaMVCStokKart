...
public class DeleteStokController implements ActionListener {
	private StokKartModel mod;
	private MainFrame mainFrame;
	private StokKartFrame stokEkleFrame;
	private StokListFrame stokListeleFrame;
	private DeleteStokController deleteController;

	public DeleteStokController(StokKartModel mod, MainFrame mainFrame, StokKartFrame stokEkleFrame,
			StokListFrame stokListeleFrame) {
		this.mod = mod;
		this.mainFrame = mainFrame;
		this.stokEkleFrame = stokEkleFrame;
		this.stokListeleFrame = stokListeleFrame;
		this.stokEkleFrame.btnSil.addActionListener(this);
	...
	private void buttonClicked(ActionEvent e) {
		if (e.getSource().equals(StokKartFrame.btnSil))

		{// sil
			String stokAra = StokKartFrame.TxtAra.getText();
			mod.setStokKodu(StokKartFrame.TxtStokKodu.getText());

			if (mod.sil(mod) && !stokAra.equals("")) {
